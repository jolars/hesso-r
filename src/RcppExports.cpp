...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(lassoPathDense(X, y, family, lambdas, lambda_type, standardize, screening_type, shuffle, check_frequency, screen_frequency, hessian_warm_starts, augment_with_gap_safe, log_hessian_update_type, path_length, maxit, tol_gap, gamma, store_dual_variables, verify_hessian, line_search, verbosity));
...
RcppExport SEXP _hesso_lassoPathSparse(SEXP XSEXP, SEXP ySEXP, SEXP familySEXP, SEXP lambdasSEXP, SEXP lambda_typeSEXP, SEXP standardizeSEXP, SEXP screening_typeSEXP, SEXP shuffleSEXP, SEXP check_frequencySEXP, SEXP screen_frequencySEXP, SEXP hessian_warm_startsSEXP, SEXP augment_with_gap_safeSEXP, SEXP log_hessian_update_typeSEXP, SEXP path_lengthSEXP, SEXP maxitSEXP, SEXP tol_gapSEXP, SEXP gammaSEXP, SEXP store_dual_variablesSEXP, SEXP verify_hessianSEXP, SEXP line_searchSEXP, SEXP verbositySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< const bool >::type line_search(line_searchSEXP);
    Rcpp::traits::input_parameter< const arma::uword >::type verbosity(verbositySEXP);
    rcpp_result_gen = Rcpp::wrap(lassoPathSparse(X, y, family, lambdas, lambda_type, standardize, screening_type, shuffle, check_frequency, screen_frequency, hessian_warm_starts, augment_with_gap_safe, log_hessian_update_type, path_length, maxit, tol_gap, gamma, store_dual_variables, verify_hessian, line_search, verbosity));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_hesso_lassoPathDense", (DL_FUNC) &_hesso_lassoPathDense, 21},
    {"_hesso_lassoPathSparse", (DL_FUNC) &_hesso_lassoPathSparse, 21},
    {NULL, NULL, 0}
};
